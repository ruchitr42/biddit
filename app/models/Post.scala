...
//
//case class Post(id: Long, userId: Long, title: String, content: String, status: String, postType: String, createdAt: Timestamp, updatedAt: Timestamp, publishedAt: Option[Timestamp])
//
//  object Post {
...
object Post {
  implicit val timestampFormat: Format[Timestamp] = new Format[Timestamp] {
    ...
    override def reads(json: JsValue): JsResult[Timestamp] = json match {
      case JsString(str) =>
        try JsSuccess(Timestamp.valueOf(str))
        catch {
